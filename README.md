...
详细的 Agent 架构设计、LangGraph 工作流、技能插件化机制以及融合决策矩阵，请参阅 [AGENT_ARCHITECTURE.md](AGENT_ARCHITECTURE.md)。
...
将以上内容保存为 `README.md` 并推送到仓库根目录，你的项目主页就会显示这份清晰的中文介绍。如果需要英文版本，可以在同一文件中用中英双语分段展示。
